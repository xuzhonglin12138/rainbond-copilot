const DEFAULT_NARRATIVE_BUDGET = 32000;
const DEFAULT_TOOL_OUTPUT_BUDGET = 6000;
/**
 ...
 */
export function createSkillSummarizer(opts) {
...
function serializeToolOutput(value, budget) {
    let serialized;
    try {
